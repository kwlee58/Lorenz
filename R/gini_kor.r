...
png("laurenz-curve-kor.png",width=480,height=480)
x<-income.5level.kor$level*100
y<-income.5level.kor$cumulative
plot(x,y,type="l",xlab="",ylab="")
abline(v=x,h=c(0,100),lty=2)
...
title(main="로렌쯔 커브",xlab="소득순 사람들의 누적 점유율",ylab="소득의 누적 비율")
text(x=40,y=60,"지니계수=0.306")
